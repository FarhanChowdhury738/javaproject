...
public class MediumPackage extends JFrame implements ActionListener
{
	JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17,l18,l19;
		...
		ImageIcon img = new ImageIcon("Images/MediumPackage.png");
		...
		l11 = new JLabel("Medium Package (7 Day's)");
		...
		l12 = new JLabel("1 Medium Conference Room");
		...
		{
			MediumPackage p = new MediumPackage();
			p.show();
