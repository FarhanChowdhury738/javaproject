...
public class PaymentPage4 extends JFrame implements ActionListener
{
	...
	this.setSize(854,500);
		...
		public void actionPerformed(ActionEvent ae)
		{
			...
			{  
		      if (c2.isSelected())
		{
				BkashPayment4 f= new BkashPayment4();
				this.setVisible(false);
				f.setVisible(true);
		}
		 else if (c1.isSelected())
		{
				NagadPayment4 f= new NagadPayment4();
				this.setVisible(false);
				f.setVisible(true);
		}
		else {
		...
		public static void main(String args [])
		{
			...
			PaymentPage3 p = new PaymentPage3();
			p.show();
