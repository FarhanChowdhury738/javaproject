...
public class LargePackage extends JFrame implements ActionListener
{
	JLabel l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,l15,l16,l17,l18,l19;
		...
		ImageIcon img = new ImageIcon("Images/LargePackage.png");
		...
		l11 = new JLabel("Large Package (30 Day's)");
		l11.setFont(new Font("Dosis",Font.PLAIN,29));
		l11.setForeground(Color.black);
		l11.setBounds(145,0,400,200);
		this.add(l11);
		
		
		l12 = new JLabel("1 Big Conference Room");
		...
		public void actionPerformed(ActionEvent ae)
		{
		...
		else if(ae.getSource()==b2)
			{
				...
				ConfirmPaymentPage3 f = new ConfirmPaymentPage3();
				this.setVisible(false);
				f.setVisible(true);
		}
		...
		{
			LargePackage p = new LargePackage();
			p.show();
